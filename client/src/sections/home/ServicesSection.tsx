      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 max-w-3xl mx-auto">
            Rooks Roofing provides comprehensive roofing solutions for residential and commercial properties throughout Central Oregon. With our team of experienced professionals, we deliver quality workmanship and exceptional customer service.
          </p>
        </div>
